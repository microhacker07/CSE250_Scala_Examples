...
//class Cardbox[A](keyMatch: (A,A) => Boolean = ((a:A,b:A) => a == b)) extends SinglyLinkedList[A](keyMatch)
//class Cardbox[A](keyMatch: (A,A) => Boolean = ((a:A,b:A) => a == b)) extends DoublyLinkedList[A](keyMatch)
